    ...
    <div className="w-full rounded-lg shadow-md flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-6 px-4 sm:px-6 lg:px-0">
      ...
      <div className="flex-1 w-full text-center lg:text-left">
        ...
        <p className="text-lg sm:text-xl mb-6">
          Восстанавливаем стабильность работы информационных систем. Диагностируем и устраняем серьезные уязвимости в безопасности и отказоустойчивости IT-системы, которые уже приводят к убыткам для компании. Создаём возможности для развития бизнеса
        </p>

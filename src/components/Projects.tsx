...
export function ProjectsCards() {
    ...
    <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-full rounded-xl p-4 border">
        ...
        <CardItem as="p" translateZ="60" className="text-neutral-500 text-sm mt-2 dark:text-neutral-300 line-clamp-3">
            {description}
        </CardItem>
    ...
    {[
        ...
        <CardContainer key={index} className="inter-var mb-6 w-3/4 h-4/4">
    <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-full rounded-xl p-4 border">
        <CardItem translateZ="50" className="text-xl font-bold text-neutral-600 dark:text-white">
            {title}
        </CardItem>
        ...
        <CardItem translateZ="100" className="w-full mt-4">
            <Link href={link}>
                <Image
                    src={imgSrc}
                    height={500} // Размер изображения
                    width={500}  // Размер изображения
                    className="h-40 w-full object-contain object-center rounded-xl group-hover/card:shadow-xl"
                    alt="thumbnail"
                />
            </Link>
        </CardItem>

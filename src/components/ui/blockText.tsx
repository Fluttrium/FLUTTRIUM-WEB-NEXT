...
const FlutterInfo = () => {
  ...
  return (
    <div className="w-full mx-4 sm:mx-20 rounded-lg shadow-md flex flex-col sm:flex-row items-center z-50">
      {" "}
      {/* Flex для выравнивания на мобильных и десктопных экранах */}
      <div className="flex-1 text-center sm:text-left sm:px-20 mb-8 sm:mb-0">
        {" "}

            ...
            <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
                <div className="space-y-8">
                    <h1 className={`${textStyles.h1} md:text-8xl leading-tight`}>
                        Студенческий <span className={textStyles.gradient}>Стартап</span>
                    </h1>
                    <p className={`${textStyles.body1} md:text-3xl text-gray-300 max-w-4xl mx-auto leading-relaxed`}>
                        Превращаем твою идею в успешный стартап с <span className="text-blue-400 font-semibold">грантом 1 млн рублей</span>
                    </p>
        ...
        <section>
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className={`${textStyles.h2} text-white mb-6`}>Наши успешные кейсы</h2>
                    <p className={`${textStyles.body1} md:text-2xl ${colors.dark.text.secondary} max-w-4xl mx-auto`}>
                        Мы уже помогли студентам получить гранты и реализовать свои идеи. <span className="text-blue-400">Теперь ваша очередь!</span>
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
                    {projects.map((project) => (
                        ...
                        >
                            ...
                            <div className="text-blue-400 mb-6 font-medium">Направление: {project.direction}</div>
                            <div className="grid grid-cols-2 gap-6 text-sm mb-6">
                                <div className="p-4 bg-gray-700/30 rounded-lg">
                                    <div className="text-gray-400 mb-1">Студент:</div>
                                    <div className="text-white font-medium">{project.student}</div>
                                </div>
                                <div className="p-4 bg-gray-700/30 rounded-lg">
                                    <div className="text-gray-400 mb-1">Результат:</div>
        ...
        <section className="py-24">
            <div className="max-w-5xl mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className={`${textStyles.h2} mb-6`}>Готов превратить идею в стартап?</h2>

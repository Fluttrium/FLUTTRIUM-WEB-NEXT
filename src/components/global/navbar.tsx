    ...
    <Menu setActive={setActive}>
      ...
      <MenuItem setActive={setActive} active={active} item={t('mainNavItm6')}>
        <div className="text-sm grid grid-cols-2 gap-10 p-4">
          <ProductItem title="Flutter" href="/flutter" src="/flutter-10181843-8492733.png" description={t('description5')} />
          <ProductItem title="Next JS" href="/nextjs" src="/projects/nextjs-light.svg" description={t('description6')} />
        </div>
      </MenuItem>
    </Menu>
  </nav>

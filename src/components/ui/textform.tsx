...
export function TextForm() {
  ...
  return (
    <div className="w-full py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8 max-w-5xl mx-auto text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-white leading-tight break-words">{t?.h2 || ''}</h2>
      <p className="text-base sm:text-lg mb-3 sm:mb-4 text-white leading-relaxed break-words">{t?.p || ''}</p>

    ...
    return (
        <section className="w-screen !overflow-hidden">
            ...
            <TypewriterEffect
                ...
                words={words}
            />
            <div className="px-28 space-x-10 gap-10 flex flex-wrap">
                {/* Контейнер для горизонтального скролла на мобильной версии */}
                <div className="overflow-x-auto sm:hidden flex flex-wrap">
                    ...
                    {[{
                        ...
                        <CardContainer key={index} className="inter-var mb-6 w-64 flex-shrink-0">
                            <CardBody
                                ...
                                <CardItem translateZ="100" className="w-full mt-2">
                                    <Link href={link}>
                                        <Image
                                            ...
                                            width={300} // Задайте нужную ширину
                                            className="h-40 w-full object-contain rounded-xl group-hover/card:shadow-xl" // Замените object-cover на object-contain
                                            alt="thumbnail"
                                        />
                                    </Link>
                                </CardItem>
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    {[{
                        ...
                        <CardContainer key={index} className="inter-var mb-6">
                            <CardBody
                                ...
                                <CardItem translateZ="100" className="w-full mt-4">
                                    <Link href={link}>
                                        <Image
                                            ...
                                            height={300} // Задайте нужную высоту
                                            width={300} // Задайте нужную ширину
                                            className="h-60 w-full object-contain rounded-xl group-hover/card:shadow-xl" // Замените object-cover на object-contain
                                            alt="thumbnail"
                                        />
                                    </Link>
                                </CardItem>

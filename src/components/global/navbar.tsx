    ...
    return (
        <header
            ...
            <aside className="flex items-center gap-4">
                <LanguageSwitcher/> {/* Добавьте переключатель языков здесь */}
                <p className="hidden md:block text-2xl font-semibold mr-2">+7(921)011-27-94</p>
                <Link
                    href="/dashboard"
                ...
                <p className="md:hidden text-2xl font-semibold text-white">+7(921)011-27-94</p>
            </aside>
        </header>
    );
};

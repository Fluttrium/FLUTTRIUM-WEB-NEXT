            ...
            <Menu setActive={setActive}>
              ...
              >
                <div className="text-sm grid grid-cols-1 gap-4 p-3 lg:p-4 lg:grid-cols-2 lg:gap-6">
                  <ProductItem
                      title={messages.navbar?.title1 || "Коробочное приложение для ритейла"}
                      href="/retail"
                  ...
                  />
                  <ProductItem
                      title={messages.navbar?.title6 || "Seo оптимизация, Яндекс Директ"}
                      href="/direct"
                      src="/Direct.png"
                      description={
                ...
                {["en", "ru", "cz", "de"].map((lang) => (
                    ...
                    >
                      <div className="flex items-center justify-between w-full">
                        ...
                        {language === lang && <div className="h-1 bg-blue-400 w-4 rounded-full" />}
                      </div>
                    </DropdownMenuItem>
                ))}
              </DropdownMenuContent>

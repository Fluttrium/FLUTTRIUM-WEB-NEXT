    ...
    <div className="mx-auto bg-white shadow-lg rounded-lg overflow-hidden p-8 my-8 py-8">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between md:space-x-8 space-y-8 md:space-y-0">
        ...
        <div className="bg-blue-100 rounded-full w-20 h-20 md:w-24 md:h-24 flex items-center justify-center">
          <span className="text-blue-600 font-semibold text-lg md:text-2xl">
            Next.js
          </span>
        </div>
        ...
        <div className="w-full flex justify-center md:w-auto">
          <Link href="/brief">
            <button className="flex items-center px-10 py-3 border-2 border-black dark:border-white uppercase bg-blue-600 text-white transition duration-200 text-base md:text-lg rounded-full">
              {m?.development?.cta}
              <svg

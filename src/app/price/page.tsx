    ...
    <LampContainer>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:space-x-10 space-y-10 sm:space-y-0 sm:mt-0 mt-20">
          {/* Standard plan */}
          <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900 flex flex-col justify-between items-center gap-7 sm:h-full">
            ...
            <Link href="/brief">
              <button className="bg-blue-600 text-white text-xs sm:text-sm px-3 sm:px-4 py-1 sm:py-2 rounded-lg shadow-lg transition duration-300 hover:bg-blue-700">
          ...
          {/* Premium plan */}
          <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900 flex flex-col justify-between items-center gap-6 sm:h-full">
            <p className="text-2xl sm:text-3xl dark:text-neutral-200">Премиум план разработки</p>
            <div className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400">
              <h2 className="text-base sm:text-xl font-semibold mb-1 sm:mb-2 text-center">
                Что включено:
              </h2>
          ...
          {/* Custom services */}
          <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900 flex flex-col justify-between items-center gap-2 sm:h-full">
            <p className="text-2xl sm:text-3xl dark:text-neutral-200">Индивидуальные услуги</p>
            <div className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400">
              <h2 className="text-base sm:text-xl font-semibold mb-1 sm:mb-2 text-center">
                Что включено:
              </h2>

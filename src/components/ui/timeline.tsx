...
export const Timeline = ({data}: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            ...
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto pb-6 px-6 md:px-10 lg:px-12">
                ...
                <p className="text-xl md:text-2xl dark:text-300">
                    Мы выстроили процесс разработки кастомных приложений на телефон и корпоративных сервисов так, чтобы
                    компания регулярно видела промежуточные результаты и могла корректировать их. Таким образом наши
                    клиенты получают именно тот продукт, который им нужен
                </p>
            </div>

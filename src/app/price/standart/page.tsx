...
const StandardPlan = () => {
  return (
    <div className=" p-1 sm:p-2 flex items-center justify-center  bg-black bg-opacity-50 overflow-hidden">
      <div className="ring-container p-0.25 rounded-2xl relative z-10 shadow-lg animate-float">
        <div className="content-container max-w-xl mx-auto rounded-2xl p-1 sm:p-2 bg-white bg-opacity-90">
          ...
          <ul className="list-disc list-inside text-xs sm:text-sm mb-1 sm:mb-2 text-gray-800">
            <li>
              Разработка многостраничного сайта/приложения (до 10
              страниц/экранов)
            </li>
          ...
          <div className="flex justify-center mt-2 sm:mt-3">
            <Link href="/contact">
              <button className="bg-blue-600 text-white text-xs sm:text-sm px-3 sm:px-4 py-1 sm:py-2 rounded-full shadow-lg transition duration-300 hover:bg-blue-700">
                Заказать
              </button>
            </Link>
          </div>

  ...
  return (
    <div className="relative flex flex-col md:flex-row mx-auto px-8 py-16">
      ...
      <div className="hidden md:block w-full md:w-1/4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">{m?.sidebar?.title}</h3>
          <p className="text-lg text-gray-700 mb-6">{m?.sidebar?.description}</p>
          <button

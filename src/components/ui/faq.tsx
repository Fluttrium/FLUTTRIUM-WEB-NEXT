...
export function FAQ() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
      <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 sm:mb-5 text-center leading-tight break-words">
        {t?.title || ""}
      </h2>
      <div className="space-y-3 sm:space-y-4">
        {items.map((stage, index) => (
          ...
          >
            ...
            >
              <PlusIcon />
              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium leading-tight break-words">
                {stage.question}
              </h3>
            </button>
            {openIndex === index && (

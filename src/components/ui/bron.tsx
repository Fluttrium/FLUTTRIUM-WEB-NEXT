...
const BookDemo = () => {
  ...
  const t: any = (messages as any).RetailBookDemo;
  return (
    <div className="mt-12 p-8 bg-transparent rounded-3xl shadow-lg">
      <h2 className="text-4xl md:text-6xl font-bold mb-8 text-center text-white">{t?.title || 'Забронировать демо'}</h2>
      <div className="flex flex-col md:flex-row items-center">
        <div className="flex-1 mb-8 md:mb-0 text-center">
          <p className="text-2xl md:text-4xl mb-4 text-white">{t?.subtitle || 'Закажите демо, и менеджер Flutter продемонстрирует вам универсальное приложение в действии'}</p>

...
export default function Home() {
  ...
  return (
    <main className="relative overflow-hidden w-full h-full">
      <Hero />
      {/*<section className="mp-10 h-auto md:h-screen w-full relative flex antialiased">*/}
      {/*  <div className="flex items-center justify-center md:flex-row md:mx-10 z-50 px-4 w-full h-full mt-16 md:mt-20 lg:mt-24">*/}
